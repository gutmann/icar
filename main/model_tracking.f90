...
contains
    ...
    subroutine init_model_diffs()
        ...
        "      lt:LUT_filename, mp:update_interval, vert_smooth in lt_parameters,"  //  &
        ...
        "Added ability to read a bias correction field for precip, and a top "      //  &
        "      boundary condition for temperature, humidity, and hydrometeors (qc)."    &
        ]
